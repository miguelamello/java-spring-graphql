...
```
Note: The structure of the type `Meter` and `Measurement` should mimic the structure of the database tables. In this case, the database tables are `meters` and `measurements
