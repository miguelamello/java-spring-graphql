...
Returns an array of meters. Each meter object contains the meter `id`, `name`, `location`, `created`, `updated` and the list of `readings` associated with the meter (if any).
